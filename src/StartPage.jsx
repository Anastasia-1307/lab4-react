...
const handleSubmit = (event) => {
 ...
 sessionStorage.setItem('intrebari', JSON.stringify(questionurl));
...
setAleatoriu(true);
    ...
    return (
        ...
        <label htmlFor="numele">Introdu numele: </label>
          ...
          <input type="radio" id="zece" name="timp" value="10 secunde" checked={limitaTimp === '10 secunde'} onChange={(e) => setLimitaTimp(e.target.value)}/>
          {error && <p className="error">{error}</p>}
          <Button onClick={handleSubmit}>Începe testul</Button>
        </form>
